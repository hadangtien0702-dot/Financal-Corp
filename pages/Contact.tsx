...
export const ContactPage: React.FC = () => {
  ...
  return (
    <div className="bg-white">
      {/* Header Section */}
      <div className="bg-gradient-to-br from-primary to-blue-600 py-20 md:py-28 relative overflow-hidden text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 mb-24">
          ...
          {/* Contact Form */}
          <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-10 border border-gray-100 relative order-2 lg:order-1 animate-fade-in-up" style={{animationDelay: '0.2s'}}>
